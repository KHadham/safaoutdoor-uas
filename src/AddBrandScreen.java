...
public class AddBrandScreen extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AddBrandScreen
     */
    public AddBrandScreen() {
        initComponents();
        datatable();
        Clear();
    }
    ...
    private void initComponents() {
        ...
        tabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Brand", "Nama Brand", "Alamat Brand"
            }
        ) {
        ...
        jLabel2.setText("Management Brand");
    ...
    protected void datatable() {
        Object[] Baris = {"ID Brand", "Nama Brand", "Alamat Brand"};
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        if (selectedRow != -1) {
            ...
            txt_alamat.setText(tabel.getValueAt(selectedRow, 2).toString());
        }        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddBrandScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddBrandScreen().setVisible(true);
            }
        });
    }
