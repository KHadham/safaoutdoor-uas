...
public class AddSizeScreen extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AddSizeScreen
     */
    public AddSizeScreen() {
        initComponents();
        datatable();
    ...
    private void initComponents() {
        ...
        tabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Ukuran", "Label Ukuran", "Kategori Barang"
            }
        ) {
        ...
        jLabel2.setText("Management Ukuran");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(selectionKategori, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    protected void datatable() {
        Object[] Baris = {"ID Ukuran", "Kategori", "Label Ukuran",};
        tabmode = new DefaultTableModel(null, Baris);
        try {
            String queryx = "SELECT * FROM size";
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        if (ok == 0) {
            ...
            try {
                ...
                String sql = "delete from size where id_size ='" + selectedId + "'";
                PreparedStatement stat = konek.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        if (selectedRow != -1) {
            ...
            txt_nama.setText(tabel.getValueAt(selectedRow, 2).toString());
            selectionKategori.setSelectedIndex(helper.updateComboBoxSelection(selectionKategori, tabel.getValueAt(selectedRow, 1).toString()));
        }
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        try {
            ...
            PreparedStatement stat = konek.prepareStatement(sql);
            stat.setString(1, selectionKategori.getSelectedItem().toString().split(":")[0].trim().replaceAll("[^0-9]", ""));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSizeScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSizeScreen().setVisible(true);
            }
        });
    }
